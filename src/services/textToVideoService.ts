...
// Generate video from text using Seedance T2V model
export async function generateTextToVideo(
  ...
  try {
    console.log('Starting Seedance T2V text-to-video generation...');
    ...
    console.error('Full text-to-video generation error:', {
...
export async function pollForTextToVideo(
  requestId: string,
